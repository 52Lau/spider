...
public class GitHubUserInfo {
     ...
     * followers : 0
     * following : 2
     * created_at : 2018-03-19T11:04:28Z
     * updated_at : 2019-01-20T15:06:12Z
     * private_gists : 0
    ...
    public static GitHubUserInfo objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), GitHubUserInfo.class);
    ...
    public static List<GitHubUserInfo> arrayGitHubUserInfoFromData(String str) {

        Type listType = new TypeToken<ArrayList<GitHubUserInfo>>() {
        }.getType();
    ...
    public static class PlanBean {
        ...
        public static PlanBean objectFromData(String str, String key) {

            try {
                JSONObject jsonObject = new JSONObject(str);

                return new Gson().fromJson(jsonObject.getString(str), PlanBean.class);
            } catch (JSONException e) {
                e.printStackTrace();
            }
