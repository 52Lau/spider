...
<div class="x-body">
    ...
    <div class="layui-input-inline">
        <select name="isclip">
            ...
            <input type="text" name="videoid"  placeholder="视频id" autocomplete="off" class="layui-input">-->
        <button class="layui-btn" id="layuibtn" data-type="reload">搜索</button>
        <#--<button class="layui-btn" id="query" lay-filter="sreach"><i class="layui-icon">&#xe615;</i></button>-->
    </div>
